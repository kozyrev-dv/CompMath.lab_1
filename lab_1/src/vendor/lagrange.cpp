...
/**
* Lagrange-interpolates using nodes specified and evaluating its value at x
* 
* @param knots amount n
* @param knots' xs at arrPoints[]
* @param knots' f(x)s at arrFunctions[]
* @param use m knots from table
* @param evaluate at x
*/
